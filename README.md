...
<div align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/mohameddsalmann/mohameddsalmann/output/github-snake-dark.svg" />
    <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/mohameddsalmann/mohameddsalmann/output/github-snake.svg" />
    <img alt="github-snake" src="https://raw.githubusercontent.com/mohameddsalmann/mohameddsalmann/output/github-snake-dark.svg" width="100%"/>
  </picture>
</div>
...
jobs:
  build:
    ...
    steps:
      - uses: Platane/snk@v3
        with:
          github_user_name: mohameddsalmann
          outputs: |
